...
public class UpComingCarAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UpComingCarAdapter(Context context, List<UpcomingCarModel> upcomingCarModelList, int type, int dataType) {
    ...
    public void onViewRecycled(@NonNull RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof ViewHolder) {
            ((ViewHolder) holder).carImageView.setImageDrawable(null);
            ((ViewHolder) holder).brandLogoImageView.setImageDrawable(null);
            ((ViewHolder) holder).carSubtitle.setText("");
            ((ViewHolder) holder).carTitle.setText("");
        }
    }
}
